...
public class MartianManagerTest {
	...
	public static void testGetMartianAt_ValidIndex() {
		System.out.println("\n-->testGetMartianAt_ValidIndex");
		MartianManager vod = managerWith4();
		int index = 0;
		String ex = "RedMartian toString id:1";
		Martian actual = vod.getMartianAt(index);
	...
	public static void testGetMartianWithId_Success() {
		...
		int id = 3;
		String ex = "Green Martian with id:3";
		Martian ac = vod.getMartianWithId(id);
		String msg = String.format("Expected result: %s", ex);
		msg += String.format("\nActual result: %s", ac);
		System.out.println(msg);
	}
	...
	public static void testGetTeleporterAt_ValidIndex() {
		...
		Teleporter ac = vod.getTeleporterAt(index);
		String msg = String.format("Expected result: %s", ex);
		msg += String.format("\nActual result: %s", ac);
		System.out.println(msg);
	}
	...
	public static MartianManager managerWith4() {
		MartianManager vod = new MartianManager();
	...
	public static MartianManager managerWithOutO() {
		MartianManager vod = new MartianManager();
		RedMartian it = new RedMartian(4,6);
		GreenMartian sar = new GreenMartian(8, 4);
		RedMartian bob = new RedMartian(1,4);
		GreenMartian tiny = new GreenMartian(2, 7);
		vod.addMartian(it); vod.addMartian(sar); vod.addMartian(bob);vod.addMartian(tiny);
		return vod;
	}
