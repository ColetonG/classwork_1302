...
public class RefrigeratedItemTest {
	...
	public static void testEqualsMethod_false() {
		...
		RefrigeratedItem i1 = new RefrigeratedItem("Frost", 2.2, 4.1);
		RefrigeratedItem i2 = new RefrigeratedItem("Milk", 2.4, 8.1);
	...
	public static void testEqualsMethod_true() {
		...
		RefrigeratedItem i1 = new RefrigeratedItem("Frost", 2.2, 4.1);
		RefrigeratedItem i2 = new RefrigeratedItem("Frost", 2.4, 8.1);
